...
Virtual file handle to represent picture, video and image sequence
"""
...
from .FloDecoder import KITTI, open_flo
    ...
    def read_frame(self, frames=1, *args):
        ...
        if self.mode in ('YV12', 'YV21', 'NV12', 'NV21',):
            ...
            for _ in range(frames):
                ...
                ret.append(Image.frombytes(
                    'YCbCr', self._size, data, self.mode))
            return ret
