...
from .discriminator import (Discriminator_VGG_128, Discriminator_VGG_256,
                            Discriminator_VGG_512, NLayerDiscriminator,
                            VGGFeatureExtractor)
...
def define_G(which_model='RRDBNet', **opt):
    ...
    if which_model == 'RRDBNet':
        ...
        raise NotImplementedError(
            f'Generator model [{which_model}] not recognized')
