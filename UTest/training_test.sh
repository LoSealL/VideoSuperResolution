...
python run.py --model=carn --data_config=../UTest/data/fake_datasets.yml --dataset=normal --epochs=1 --test=bar --steps_per_epoch=1
python run.py --model=dbpn --data_config=../UTest/data/fake_datasets.yml --dataset=normal --epochs=1 --test=bar --steps_per_epoch=1
python run.py --model=dcscn --data_config=../UTest/data/fake_datasets.yml --dataset=normal --epochs=1 --test=bar --steps_per_epoch=1
python run.py --model=edsr --data_config=../UTest/data/fake_datasets.yml --dataset=normal --epochs=1 --test=bar --steps_per_epoch=1
python run.py --model=idn --data_config=../UTest/data/fake_datasets.yml --dataset=normal --epochs=1 --test=bar --steps_per_epoch=1
python run.py --model=lapsrn --data_config=../UTest/data/fake_datasets.yml --dataset=normal --epochs=1 --test=bar --steps_per_epoch=1
python run.py --model=memnet --data_config=../UTest/data/fake_datasets.yml --dataset=normal --epochs=1 --test=bar --steps_per_epoch=1
python run.py --model=msrn --data_config=../UTest/data/fake_datasets.yml --dataset=normal --epochs=1 --test=bar --steps_per_epoch=1
python run.py --model=rcan --data_config=../UTest/data/fake_datasets.yml --dataset=normal --epochs=1 --test=bar --steps_per_epoch=1
python run.py --model=rdn --data_config=../UTest/data/fake_datasets.yml --dataset=normal --epochs=1 --test=bar --steps_per_epoch=1
python run.py --model=srdensenet --data_config=../UTest/data/fake_datasets.yml --dataset=normal --epochs=1 --test=bar --steps_per_epoch=1
python run.py --model=srfeat --data_config=../UTest/data/fake_datasets.yml --dataset=normal --epochs=1 --test=bar --steps_per_epoch=1
python run.py --model=srgan --data_config=../UTest/data/fake_datasets.yml --dataset=normal --epochs=1 --test=bar --steps_per_epoch=1
python run.py --model=dncnn --data_config=../UTest/data/fake_datasets.yml --dataset=normal --epochs=1 --test=bar --steps_per_epoch=1
# Test VSR Models
